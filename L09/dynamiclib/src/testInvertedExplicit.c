...
typedef void (*initInverted_fn)(PROC **, int, int);
typedef long (*translate_fn)(PROC *, int, int, int);
typedef void (*printInverted_fn)(PROC *);
typedef int  (*lookUp_fn)(PROC *, int, int);
typedef int  (*findOldest_fn)(PROC *);

static initInverted_fn  p_initInverted;
static translate_fn     p_translate;
static printInverted_fn p_printInverted;
static lookUp_fn        p_lookUp;
static findOldest_fn    p_findOldest;

#define initInverted  p_initInverted  
#define translate     p_translate
#define printInverted p_printInverted
#define lookUp        p_lookUp
#define findOldest    p_findOldest
